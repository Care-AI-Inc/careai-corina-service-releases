...
'@
    ...
    if ($Instance) {
        ...
        $taskArgument = "-NoProfile -ExecutionPolicy Bypass -Command `"`$env:CorinaRegistryInstance='$Instance'; `$env:DOTNET_ENVIRONMENT='Production'; & '$shimPath'; exit `$LASTEXITCODE`""
    } else {
